document.addEventListener("DOMContentLoaded", function () {
  ...
  let deliveryFee = parseFloat(deliveryFeeElem.textContent);
  ...
  // Attach remove functionality to existing pizzas
  document.querySelectorAll(".removePizzaBtn").forEach((button) => {
    const li = button.closest("li");
    const pizzaText = li.textContent;
    let pizzaPrice = 0.0;
    if (pizzaText.includes("Small")) {
      pizzaPrice = 10.0;
    } else if (pizzaText.includes("Medium")) {
